...
def process_one_take_by_segment(take_json):
    ...
    feature_dict = f'/home/ubuntu/AutomataLearning/egoexo4d/data/features/omnivore_video'
    pattern = os.path.join(feature_dict, f'{take_uid}_aria*_rgb.pt')
...
def multi_process_by_segment(set):
    ...
    torch.save(meta_data, f"data_embedding/omnivore_segment_metadata_{set}.pt")
    torch.save(video_embedding_data, f"data_embedding/omnivore_segment_video_embedding_{set}.pt")
